...
<div class="hero">
  ...
  <h1>Minsuk Jang</h1>
  <div class="hero-sub">M.S. @ KAIST &nbsp;·&nbsp; Civil Engineer × Robotics &amp; 3D Sensing</div>
  <p class="hero-statement">
    I build <strong>real-world robotic sensing systems</strong> — LiDAR-inertial SLAM, mobile mapping,
    UAV remote sensing, and 3D digital twins for construction and infrastructure.
  </p>
  <div class="hero-stats">
    <div class="hero-stat"><div class="num">Exited</div><div class="lbl">Shipped &amp; acquired iOS LiDAR-SLAM app (DepthViz)</div></div>
    <div class="hero-stat"><div class="num">9 Patents</div><div class="lbl">LiDAR mapping · 3D reconstruction · UAV</div></div>
    <div class="hero-stat"><div class="num">CES 2025</div><div class="lbl">Drone-SAR 3D digital twin exhibited</div></div>
  </div>
  <div class="hero-links">
    <a class="hero-btn primary" href="/about/">About me</a>
    <a class="hero-btn" href="/research/">Research</a>
    <a class="hero-btn" href="/assets/files/CV_minsuk.pdf" target="_blank">CV</a>
    <a class="hero-btn" href="https://scholar.google.com/citations?user=2ARVuOcAAAAJ&hl=ko" target="_blank">Scholar</a>
    <a class="hero-btn" href="https://github.com/tersite1" target="_blank">GitHub</a>
    <a class="hero-btn" href="mailto:minsukjang@kaist.ac.kr">Email</a>
  </div>
</div>
