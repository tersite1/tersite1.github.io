...
I reconstructed the Yonsei engineering building end to end: I generated NeRF-based 3D models, captured the structure by direct mobile scanning, and registered the two into a single, complete 3D model, using the mobile scan to correct the NeRF reconstruction's geometry while keeping its visual density.
